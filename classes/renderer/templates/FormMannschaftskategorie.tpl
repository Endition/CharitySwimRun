		...
		<div class="card">
			...
			<div class="card-body">
						<form role="form" name="MannschaftskategorieForm" id="StreckenForm"
                            ...
                            {include file='templateInputElement.tpl' name='mannschaftskategorie' type='text' value=$mannschaftskategorie->getMannschaftskategorie() required=true bezeichnung='Bezeichnung der Kategorie'}
