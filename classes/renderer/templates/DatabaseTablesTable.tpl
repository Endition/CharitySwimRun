    <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input class="btn btn-warning" formaction="{$actionurl}&action=populateData" type="submit" name="populateData" value="Standarddaten anlegen (Transponder, Vornamen, Urkunden)" onClick="return confirm('Soll die Standarddaten wirklich angelegt werden? Vorhandene Daten in diesen Tabellen werden gelöscht!')" />
                    </form>
                </div>
            </div>
</div>