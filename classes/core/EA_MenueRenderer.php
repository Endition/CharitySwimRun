    ...
    private $menueStruktur = array(
        ...
        "02-00-00" => array("name" => "Administration", "doc" => "admin", "icon" => "fas fa-wrench fa-fw", "necassaryRoleId"=>EA_User::USERROLE_ADMIN,
            "subMenue" => array(
                ...
                "02-08-00" => array("name" => "Startzeiten", "doc" => "startzeiten", "icon" => "fa fa-clock fa-fw", "necassaryRoleId"=>EA_User::USERROLE_ADMIN),
                "02-09-00" => array("name" => "Sonderauswertungen", "doc" => "specialevaluation", "icon" => "fa flag-checkered fa-fw", "necassaryRoleId"=>EA_User::USERROLE_ADMIN),
                "02-10-00" => array("name" => "Urkunden", "doc" => "urkundengenerator", "icon" => "fa fa-file-alt fa-fw", "necassaryRoleId"=>EA_User::USERROLE_ADMIN),
                "02-11-00" => array("name" => "Starterimport", "doc" => "import", "icon" => "fa fa-exchange-alt fa-fw", "necassaryRoleId"=>EA_User::USERROLE_ADMIN),
                "02-12-00" => array("name" => "Buchungsübersicht", "doc" => "buchungsuebersicht", "icon" => "fa fa-bars fa-fw", "necassaryRoleId"=>EA_User::USERROLE_ADMIN),
