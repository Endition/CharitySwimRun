...
<head>
    ...
    <!-- Configure Progressive Web App manifest and UI theme color -->
...
<body>
 <!-- Hier wird der Toast Container eingefügt -->
 <div id="toast-container" aria-live="polite" aria-atomic="true" style="position: fixed; top: 0; right: 0; z-index: 1050;"></div>   
 <!-- Mit kopieren bei Wechsel der Index.php! -->
...
if($EA_Repository->isDoctrineConnected() === true){
 ...
 ?>
    ...
    <!-- bootstrap.bundle.min.js includes popper.js. If I include it, Table-Export is not working anymore. Without it, there is a JS-Error, but it works. -->
    <script src="vendor/twbs/bootstrap/dist/js/bootstrap.min.js"></script>
   
    <!-- Bootstrap table and PlugIns, order is important -->
    ...
    <!-- table export includes are includes in the template -->
    ...
    <!-- Bootstrap Toast Class (own creation) -->
    <script src="assets/bootstrapToastClass.js"></script>
    <!-- Intialisierung Bootstrap Toast class -->
    <script>          
